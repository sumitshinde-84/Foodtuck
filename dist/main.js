...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".shopSect{\n    width:80vw;\n    height: 100%;\n    background-color: red;\n}", "",{"version":3,"sources":["webpack://./src/css/shop.css"],"names":[],"mappings":"AAAA;IACI,UAAU;IACV,YAAY;IACZ,qBAAqB;AACzB","sourcesContent":[".shopSect{\n    width:80vw;\n    height: 100%;\n    background-color: red;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function createShop(){
    ...
    function createItem(img,Name,Price){
        ...
        const itemImg = documentc.createElement('img')
        item.src = img
